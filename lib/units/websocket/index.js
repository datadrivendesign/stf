...
var receiveEvent = require('../tapp').receiveEvent;
    ...
    new Promise(function(resolve) {
      socket.on('disconnect', resolve)
        ...
        .on('input.touchDown', function(channel, data) {
          receiveEvent('input.touchDown', data);
          push.send([
            channel
        ...
        .on('input.touchMove', function(channel, data) {
          receiveEvent('input.touchMove', data);
          push.send([
            channel
        ...
        .on('input.touchUp', function(channel, data) {
          receiveEvent('input.touchUp', data);
          push.send([
            channel
        ...
        .on('input.touchCommit', function(channel, data) {
          receiveEvent('input.touchCommit', data);
          push.send([
            channel
        ...
        .on('input.touchReset', function(channel, data) {
          receiveEvent('input.touchReset', data);
          push.send([
            channel
        ...
        .on('input.gestureStart', function(channel, data) {
          receiveEvent('input.gestureStart', data);
          push.send([
            channel
        ...
        .on('input.gestureStop', function(channel, data) {
          receiveEvent('input.gestureStop', data);
          push.send([
            channel
        ...
        .on('display.rotate', function(channel, data) {
          receiveEvent('display.rotate', data);
          push.send([
            channel
